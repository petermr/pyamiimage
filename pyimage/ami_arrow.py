...
class AmiArrow:
    ...
    def create_arrow(cls, island):
        ...
        longest_dict = cls._find_longest_dict(edge_dict)
        ...
        barbs = cls._find_barbs_and_point(ami_arrow, central_node_id, island, longest_edge, short_lines)
    ...
    @classmethod
    def _find_longest_dict(cls, edge_dict):
        longest_dict = None
    ...
    @classmethod
    def _find_barbs_and_point(cls, ami_arrow, central_node_id, island, longest_edge, short_lines):
        if len(short_lines) == 3:  # 5-node arrow - normally from thinned solid triangle
            # find straight on
            for line in short_lines:
                barbs, arrow_point_line = cls._create_barbs_point_5nodes(arrow_point_line, island, line, longest_edge,
                                                                         short_lines)
    ...
    @classmethod
    def _create_barbs_point_5nodes(cls, arrow_point_line, barbs, island, line, longest_edge, short_lines):
