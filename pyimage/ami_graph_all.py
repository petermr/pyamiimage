...
try:
    ...
    from pyamiimage.pyimage.ami_plot import AmiLine
    from pyamiimage.pyimage.ami_util import AmiUtil
    from pyamiimage.pyimage.svg import BBox
    from pyamiimage.pyimage.text_box import TextBox
